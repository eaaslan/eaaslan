...
# 📊 Stats for Nerds &nbsp;             | &nbsp; 🛠️ Current Status
<div align="center">
  <table>
    <tr>
      <td width="50%">
        <img src="https://github-readme-stats.vercel.app/api?username=eaaslan&theme=dark&hide_border=false&include_all_commits=true&count_private=true" alt="GitHub Stats"/>
      </td>
      <td width="50%">
        <h3>🎓 Professional Tutorial Collector</h3>
        <h3>💼 Full-time Stack Overflow Explorer</h3>
        <h3>🌱 Learning everything while mastering nothing</h3>
        <h3>🎯 2025 Goals: Graduate from Tutorial Hell</h3>
      </td>
    </tr>
  </table>
</div>
